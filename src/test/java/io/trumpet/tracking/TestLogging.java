...
public class TestLogging extends AbstractTrackingTestCase
{
    ...
    public void setup()
    {
        ...
        res.setHeader(TrackingFilter.X_TRUMPET_TRACK, value.toString());
    ...
    public void testLoggingFromHeader() throws Exception
    {
        ...
        req.addHeader(TrackingFilter.X_TRUMPET_TRACK, value.toString());
    ...
    public void testLoggingFromContext() throws Exception
    {
        ...
        req.setAttribute(TrackingFilter.X_TRUMPET_TRACK, value);
